// adminmap.js — shared visual map rendering for admin terminal
  ...
  const svg = `<svg width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <filter id="sh-${uid}" x="-40%" y="-40%" width="180%" height="180%">
        <feDropShadow dx="0" dy="3" stdDeviation="3.5" flood-color="rgba(0,0,0,0.35)"/>
      </filter>
    </defs>
    <circle cx="18" cy="18" r="15" fill="${color}" stroke="#ffffff" stroke-width="3" filter="url(#sh-${uid})"/>
